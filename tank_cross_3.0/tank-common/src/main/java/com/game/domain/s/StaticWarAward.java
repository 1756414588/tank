/**
 * @Title: StaticWarAward.java @Package com.game.domain.s @Description: TODO
 *
 * @author ZhangJun
...
/**
 * @ClassName: StaticWarAward @Description: TODO
 *
 * @author ZhangJun
 * @date 2015年12月18日 下午6:45:02
 */
public class StaticWarAward {
  ...
  private List<List<Integer>> rebelRankAward; // 叛军入侵周排行奖励
