/**   
 * @Title: StaticProp.java    
 * @Package com.game.domain.s    
 * @Description:   道具表配置s
 * @author ZhangJun   
 * @date 2015年8月13日 下午4:31:28    
 * @version V1.0   
 */
package com.game.domain.s;
...
public class StaticProp {
	...
	//生产该道具需要消耗的道具列表
	private List<List<Integer>> buildCost;
    ...
    public List<List<Integer>> getBuildCost() {
        return buildCost;
    }

    public void setBuildCost(List<List<Integer>> buildCost) {
