package com.account.plat.impl.muzhi1;
...
@Component
public class Muzhi1Plat extends PlatBase {
    // sdk server的接口地址
...
// 分配给游戏合作商的接入密钥,请做好安全保密
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/muzhi1/", "plat.properties");
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        ...
        try {
            ...
            if (!mysign.equals(sign)) {// 签名正确,做业务逻辑处理
                String mysign337 = com.account.plat.impl.muzhi.Rsa.getMD5(contentParam + "&key=" + MuzhiPlat.AppKey);
                if (!mysign337.equals(sign)) {
...
//			}
    ...
    public static void main(String[] args) {
        ...
        String sign = vParam[2];
        String timestamp = vParam.length == 4 ? vParam[3] : null;
        new Muzhi1Plat().verifySgin(userId + "zty337" + timestamp, sign);
    }
}
