...
LOGIN_PLATFORM_PARAM = "ifeng"


GameConfig.accountURL = "http://ifeng.tank.hundredcent.com:9200/tank_account/account/account.do"
GameConfig.areaURL = "http://ifeng.tank.hundredcent.com/serverlist_tank.json"
...
function getPayCallBackUrl()
    return "http://ifeng.tank.hundredcent.com:9200/tank_account/account/payCallback.do?plat=ifeng"
end