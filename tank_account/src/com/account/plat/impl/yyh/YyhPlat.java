package com.account.plat.impl.yyh;
...
import com.account.plat.impl.yyh.util.RSAUtil;
import com.account.util.RandomHelper;
import com.game.pb.AccountPb.DoLoginRq;
import com.game.pb.AccountPb.DoLoginRs;

@Component
public class YyhPlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/yyh/", "plat.properties");
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        ...
        // LOG.error("[结束接收参数]");
        try {
            LOG.error("[开始接收参数]" + URLDecoder.decode(content, "utf-8"));
