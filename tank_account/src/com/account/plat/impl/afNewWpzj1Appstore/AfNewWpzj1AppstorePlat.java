package com.account.plat.impl.afNewWpzj1Appstore;
...
@Component
public class AfNewWpzj1AppstorePlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/afNewWpzj1Appstore/", "plat.properties");
    ...
    private void initRechargeMap() {
        ...
        RECHARGE_MAP.put(1, "com.tank.wpzj60");
        MONEY_MAP.put(1, 6);

        RECHARGE_MAP.put(2, "com.tank.wpzj300");
        MONEY_MAP.put(2, 30);

        RECHARGE_MAP.put(3, "com.tank.wpzj980");
        MONEY_MAP.put(3, 98);

        RECHARGE_MAP.put(4, "com.tank.wpzj1980");
        MONEY_MAP.put(4, 198);

        RECHARGE_MAP.put(5, "com.tank.wpzj3280");
        MONEY_MAP.put(5, 328);

        RECHARGE_MAP.put(6, "com.tank.wpzj6480");
        MONEY_MAP.put(6, 648);
    }
    ...
    private boolean verifyAccount(String openid, String token) {
        try {
            LOG.error("afNewWpzj1_appstore开始调用sidInfo接口:" + serverUrl);
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        // TODO Auto-generated method stub
        LOG.error("pay afNewWpzj1_appstore");
        ...
        try {
            ...
            if (!APP_ID.equals(params.get("vid"))) {
                LOG.error("afNewWpzj1_appstore 充值应用ID不一致！！ ");
                return "ERROR";
            }
            ...
            if (sign.equalsIgnoreCase(originSign)) {
                ...
                if (code != 0) {
                    LOG.error("afNewWpzj1_appstore 充值发货失败！！ " + code);
                }
                return "SUCCESS";
            } else {
                LOG.error("afNewWpzj1_appstore 签名不一致！！ " + originSign + "|" + sign);
                return "ERROR";
            }
        } catch (Exception e) {
            LOG.error("afNewWpzj1_appstore 充值异常！！ " + e.getMessage());
            e.printStackTrace();
            return "ERROR";
        }
    }
