...
import com.game.domain.s.StaticActRebelAttr;
...
public class AttrData {
	...
	public AttrData(StaticTank staticTank, BossFight bossFight) {
		hp = staticTank.getHp();
		attack = staticTank.getAttack();
		hit = staticTank.getHit();
		dodge = staticTank.getDodge();
	...
	public AttrData(StaticRebelAttr staticRebelAttr,float bl) {
		hp = (long) (staticRebelAttr.getHp() * bl);
		attack = (int) (staticRebelAttr.getAttack()* bl);
		hit = (int) (staticRebelAttr.getHit()* bl);
		dodge = (int) (staticRebelAttr.getDodge()* bl);
		crit = (int) (staticRebelAttr.getCrit()* bl);
		critDef = (int) (staticRebelAttr.getCritDef()* bl);
		impale = (int) (staticRebelAttr.getImpale()* bl);
		defend = (int) (staticRebelAttr.getDefend()* bl);
		demageF = (int) (staticRebelAttr.getDamege()* bl);
		injuredF = (int) (staticRebelAttr.getInjured()* bl);
		tenacityF = 0;
		burstF = 0;
	}

	public AttrData(StaticActRebelAttr staticRebelAttr) {
		hp = staticRebelAttr.getHp();
		attack = staticRebelAttr.getAttack();
		hit = staticRebelAttr.getHit();
		dodge = staticRebelAttr.getDodge();
		crit = staticRebelAttr.getCrit();
		critDef = staticRebelAttr.getCritDef();
		impale = staticRebelAttr.getImpale();
		defend = staticRebelAttr.getDefend();
		demageF = staticRebelAttr.getDamege();
		injuredF = staticRebelAttr.getInjured();
		tenacityF = 0;
		burstF = 0;
	}
