...
@Component
public class ChYhX7Plat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/chYhX7/", "plat.properties");
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        LOG.error("chYhXq pay");
        LOG.error("chYhXq pay content:" + content);
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                LOG.error("chYhXq " + paramName + ":" + request.getParameter(paramName));
            }
            LOG.error("chYhXq [结束参数]");
            ...
            if (code == 0) {
                LOG.error("chYhXq 返回充值成功");
            } else {
                LOG.error("chYhXq 返回充值失败");
            }
            return "success";
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private String verifyAccount(String tokenkey) {
        ...
        try {
            ...
            LOG.error("chYhXq 接口返回异常:" + e.getMessage());
            e.printStackTrace();
            return null;
        }
    ...
    public String order(WebRequest request, String content) {
        ...
        LOG.error("xiao7 getXiao7GameSign param  " + JSON.toJSONString(params));
        ...
        LOG.error("xiao7 getXiao7GameSign md5Str " + md5str);
        LOG.error("xiao7 getXiao7GameSign md5v " + mysign);
        return mysign;
    }
}
