...
public class ComptePojo {
	...
	public ComptePojo(int pos, int serverId, long roleId, String nick, int bet, int myBetNum, String serverName,
			long fight, int portrait, String partyName, int level) {
		super();
		this.pos = pos;
