package com.account.plat.impl.mztkwcAppstore;
...
@Component
public class MztkwcAppstorePlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/mztkwcAppstore/", "plat.properties");
    ...
    private void initRechargeMap() {
        RECHARGE_MAP.put(1, "com.Jrutech.Tank.Produc01.new4");
        MONEY_MAP.put(1, 6);

        RECHARGE_MAP.put(2, "com.Jrutech.Tank.Produc02.new4");
        MONEY_MAP.put(2, 30);

        RECHARGE_MAP.put(3, "com.Jrutech.Tank.Produc03.new4");
        MONEY_MAP.put(3, 98);

        RECHARGE_MAP.put(4, "com.Jrutech.Tank.Produc04.new4");
        MONEY_MAP.put(4, 198);

        RECHARGE_MAP.put(5, "com.Jrutech.Tank.Produc05.new4");
        MONEY_MAP.put(5, 328);

        RECHARGE_MAP.put(6, "com.Jrutech.Tank.Produc06.new4");
        MONEY_MAP.put(6, 648);
    }
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        LOG.error("[pay mztkwc appstorePlat content]:" + content);
    ...
    private boolean verifyAccount(String userId, String usename, String sign) {
        LOG.error("mztkwc appStore 开始调用sidInfo接口");
        try {
