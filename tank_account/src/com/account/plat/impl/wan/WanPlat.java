package com.account.plat.impl.wan;
...
@Component
public class WanPlat extends PlatBase {
    // sdk server的接口地址
    ...
    private JSONObject verifyAccount(String pid, String gid, String token) {
        LOG.error("37wan 开始调用sidInfo接口");
        ...
        String body = "pid=" + pid + "&gid=" + gid + "&time=" + time + "&token=" + token + "&sign=" + sign;
