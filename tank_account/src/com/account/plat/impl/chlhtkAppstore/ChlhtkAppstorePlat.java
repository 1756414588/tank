package com.account.plat.impl.chlhtkAppstore;
...
@Component
public class ChlhtkAppstorePlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/chlhtkAppstore/", "plat.properties");
    ...
    private void initRechargeMap() {
        RECHARGE_MAP.put(1, "com.caohua.lhtk60");
        MONEY_MAP.put(1, 6);

        RECHARGE_MAP.put(2, "com.caohua.lhtk.300");
        MONEY_MAP.put(2, 30);

        RECHARGE_MAP.put(3, "com.caohua.lhtk980");
        MONEY_MAP.put(3, 98);

        RECHARGE_MAP.put(4, "com.caohua.lhtk1980");
        MONEY_MAP.put(4, 198);

        RECHARGE_MAP.put(5, "com.caohua.lhtk3280");
        MONEY_MAP.put(5, 328);

        RECHARGE_MAP.put(6, "com.caohua.lhtk6480");
        MONEY_MAP.put(6, 648);
    }
    ...
    private boolean verifyAccount(String[] param) {
        ...
        try {
            if (sign.equals(param[2])) {// 成功
                LOG.error("chlhtk_appstore 登陆成功");
                return true;
            } else {
                LOG.error("chlhtk_appstore 登陆失败");
                return false;
            }
        } catch (Exception e) {
            // TODO: handle exception
            LOG.error("chlhtk_appstore 接口返回异常:" + e.getMessage());
            e.printStackTrace();
            return false;
        } finally {
