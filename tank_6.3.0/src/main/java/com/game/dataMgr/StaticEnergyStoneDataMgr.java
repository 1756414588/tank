...
/**
 * @ClassName StaticEnergyStoneDataMgr
...
public class StaticEnergyStoneDataMgr extends BaseDataMgr {
	...
	@Override
	public void init() {
		Map<Integer, StaticEnergyStone> stoneMap = staticDataDao.selectEnergyStoneMap();
		this.stoneMap = stoneMap;

		Map<Integer, StaticEnergyHiddenAttr> hiddenMap = staticDataDao.selectEnergyHiddenAttrMap();
		this.hiddenMap = hiddenMap;

		Map<Integer, StaticAltarBoss> altarBossMap = staticDataDao.selectAltarBossMap();
		this.altarBossMap = altarBossMap;
	}
