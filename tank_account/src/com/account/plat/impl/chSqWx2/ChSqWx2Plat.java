package com.account.plat.impl.chSqWx2;
...
@Component
public class ChSqWx2Plat extends PlatBase {

    private static String APP_ID = "";
    private static String APP_KEY = "";
    private static String SERVER_KEY = "";

    private static final int chSq2 = 138;  // 草花手Q
    private static final int chWx2 = 139;  // 草花微信

    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/chSqWx2/", "plat.properties");
    ...
    public String payBack(WebRequest request, String content,
        ...
        try {
            ...
            if (code != 0) {
                LOG.error("chsqwx2 充值发货失败！！ " + code);
                return "0";
            }
            return "1";
        } catch (Exception e) {
            LOG.error("chsqwx2 充值异常:" + e.getMessage());
            e.printStackTrace();
            return "1";
        }
    }
