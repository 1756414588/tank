...
local Tank = class("Tank", Fighter)

function Tank:ctor(battleFor, pos, tankId, tankCount, hp)
	Tank.super.ctor(self, battleFor, pos, tankId, tankCount, hp)
end

function Tank:onFireEffect(targetPos)
...
-- 发射炮弹
function Tank:onFireAmmo(targetPos, firstCallback, arriveCallback, endCallback)
