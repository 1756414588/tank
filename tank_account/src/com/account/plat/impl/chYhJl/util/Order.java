...
public class Order {
     ...
     * @param playerId   玩家playerId [必填]
     * @param subject    商品名称 [必填]
     * @param apiKey     商户apiKey [必填]
     * @param totalFee   需支付金额，dealPrice值需要等于totalFee [必填]
     * @param dealPrice  商户总金额，dealPrice值需要等于totalFee [必填]
     * @param submitTime 订单提交时间，格式为yyyyMMddHHmmss，由商户服务器提供，客户端调起支付收银台时需要使用这个值 [必填]
     * @param expireTime 订单失效时间，可选，格式为yyyyMMddHHmmss，如果有值必须参与签名 [可选]
     * @param notifyURL  服务器通知地址，不能超过1024个字符，如果有该字段，必须参与签名(如果商户需要自定义参数，可以在创建订单时以
    ...
    public Order(String outOrderNo, String playerId, String subject, String apiKey, BigDecimal totalFee,
                 BigDecimal dealPrice, Timestamp submitTime, Timestamp expireTime, String notifyURL) {
