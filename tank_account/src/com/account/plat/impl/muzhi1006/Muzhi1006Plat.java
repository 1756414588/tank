package com.account.plat.impl.muzhi1006;
...
@Component
public class Muzhi1006Plat extends PlatBase {
    // sdk server的接口地址
...
// 分配给游戏合作商的接入密钥,请做好安全保密
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/muzhi1006/", "plat.properties");
    ...
    public static void main(String[] args) {
        //.error("pay muzhi1 开始调用sidInfo接口");
        String[] vParam = "47621975_mz6094182_46069522c415c7528ddbe405bd3599cd_1515740228523".split("_");
        String userId = vParam[0];
        String userName = vParam[1];
        String sign = vParam[2];
        String timestamp = vParam.length == 4 ? vParam[3] : null;
        new Muzhi1006Plat().verifySgin(userId + "zty337" + timestamp, sign);
    }
}
