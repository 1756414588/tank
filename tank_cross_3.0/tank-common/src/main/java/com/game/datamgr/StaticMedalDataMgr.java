...
public class StaticMedalDataMgr extends BaseDataMgr {
  ...
  private void initUp() {
    ...
    Map<Integer, Map<Integer, StaticMedalUp>> upMap =
        new HashMap<Integer, Map<Integer, StaticMedalUp>>();
  ...
  private void initRefit() {
    ...
    Map<Integer, Map<Integer, StaticMedalRefit>> refitMap =
        new HashMap<Integer, Map<Integer, StaticMedalRefit>>();
