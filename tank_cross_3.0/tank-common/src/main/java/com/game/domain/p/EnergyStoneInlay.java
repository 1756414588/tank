...
/**
 * @author TanDonghai @ClassName: EnergyStoneInlay @Description: 能晶镶嵌信息
...
public class EnergyStoneInlay {
    ...
    public EnergyStoneInlay(CrossTeamProto.EnergyStoneInlay pbe) {
        this.pos = pbe.getPos();
        this.hole = pbe.getHole();
        this.stoneId = pbe.getStoneId();
    }
