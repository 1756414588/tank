package com.account.plat.impl.muzhi1007;
...
@Component
public class Muzhi1007Plat extends PlatBase {
    // sdk server的接口地址
...
// 分配给游戏合作商的接入密钥,请做好安全保密
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/muzhi1007/", "plat.properties");
    ...
    public static void main(String[] args) {
        ...
        String sign = vParam[2];
        String timestamp = vParam.length == 4 ? vParam[3] : null;
        new Muzhi1007Plat().verifySgin(userId + "zty337" + timestamp, sign);
    }
}
