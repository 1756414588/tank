package com.account.plat.impl.afNewTqdknHDappstore;
...
@Component
public class AfNewTqdknHDAppstorePlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/afNewTqdknHDappstore/", "plat.properties");
    ...
    private void initRechargeMap() {
        ...
        RECHARGE_MAP.put(1, "com.gh.mftl60");
        MONEY_MAP.put(1, 6);

        RECHARGE_MAP.put(2, "com.gh.mftl300");
        MONEY_MAP.put(2, 30);

        RECHARGE_MAP.put(3, "com.gh.mftl980");
        MONEY_MAP.put(3, 98);

        RECHARGE_MAP.put(4, "com.gh.mftl1980");
        MONEY_MAP.put(4, 198);

        RECHARGE_MAP.put(5, "com.gh.mftl3280");
        MONEY_MAP.put(5, 328);

        RECHARGE_MAP.put(6, "com.gh.mftl6480");
        MONEY_MAP.put(6, 648);
    }
