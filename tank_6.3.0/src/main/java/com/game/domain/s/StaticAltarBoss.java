...
/**
 * @ClassName StaticAltarBoss.java
 * @Description 祭坛BOSS相关信息
 * @author TanDonghai
...
public class StaticAltarBoss {
	...
	public String toString() {
		return "StaticAltarBoss [lv=" + lv + ", callBossCost=" + callBossCost + ", callBossCD=" + callBossCD
				+ ", fightTime=" + fightTime + ", bossName=" + bossName + ", partAward=" + partAward + ", killAward="
				+ killAward + ", rankAward1=" + rankAward1 + ", rankAward2=" + rankAward2 + ", rankAward3=" + rankAward3
				+ "]";
	}
