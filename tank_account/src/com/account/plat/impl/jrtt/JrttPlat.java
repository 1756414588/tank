...
@Component
public class JrttPlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/jrtt/", "plat.properties");
        // if (properties != null) {
...
//			String signcontent = "buyer_id=" + buyer_id + "&client_id=" + client_id + "&notify_id=" + notify_id + "&notify_time=" + notify_time
//					+ "&notify_type=" + notify_type + "&out_trade_no=" + out_trade_no + "&pay_time=" + pay_time + "&total_fee=" + total_fee + "&trade_no="
//					+ trade_no + "&trade_status=" + trade_status + "&way=" + way;
    ...
    public static void main(String[] args) {
        String pay_key = MD5.md5Digest("9550e1303faea6eb#cff48ca2b5b3aad84dcd6b35c6f2d116");
        //LOG.error(pay_key);
    }

    // public void sortKeys(List<String> sortList, String key) {
    // for (int i = 0; i < sortList.size(); i++) {
    // String p = sortList.get(i);
    // for (int j = 0; j < p.length() && j < key.length(); j++) {
    // p.charAt(j)
    // }
    // }
    // }
