...
public class AwakenHero implements Cloneable {
     ...
     * @param a
     */
    public AwakenHero(CrossTeamProto.AwakenHero a) {
        this.keyId = a.getKeyId();
        this.heroId = a.getHeroId();
        this.state = a.getState();
        for (CrossTeamProto.TwoInt twoInt : a.getSkillLvList()) {
            skillLv.put(twoInt.getV1(), twoInt.getV2());
        }
        this.failTimes = a.getFailTimes();
    }
     ...
     * @param a
     */
    public AwakenHero(CrossSeniorMineProto.MineAwakenHero  a) {
        this.keyId = a.getKeyId();
        this.heroId = a.getHeroId();
        this.state = a.getState();
        for (CrossSeniorMineProto.MineTwoInt  twoInt: a.getSkillLvList()) {
            skillLv.put(twoInt.getV1(), twoInt.getV2());
        }
        this.failTimes = a.getFailTimes();
    }
