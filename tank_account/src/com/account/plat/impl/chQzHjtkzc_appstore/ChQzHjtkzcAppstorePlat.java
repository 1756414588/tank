package com.account.plat.impl.chQzHjtkzc_appstore;
...
@Component
public class ChQzHjtkzcAppstorePlat extends PlatBase {
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/chQzHjtkzc_appstore/", "plat.properties");
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        LOG.error("chQzHjtkzc_appstore payBack 开始 " + content);
        try {
            ...
            LOG.error("chQzHjtkzc_appstore payBack signstr:" + sb.toString());
            LOG.error("chQzHjtkzc_appstore payBack sign:" + sign);
            if (!sign.equalsIgnoreCase(checkSign)) {
                LOG.error("chQzHjtkzc_appstore payBack sign:md5验证失败");
                return "FAILURE";
            }
            ...
            if (code == 0 || code == 1) {
                LOG.error("chQzHjtkzc_appstore 充值发货成功！！ " + code);
                return "SUCCESS";
            }
            LOG.error("chQzHjtkzc_appstore 充值发货失败！！ " + code);
            return "FAILURE";


        } catch (Exception e) {
            LOG.error("chQzHjtkzc_appstore 充值异常！！ " + e.getMessage());
            e.printStackTrace();
            return "FAILURE";
        }
    }
