package com.account.plat.impl.chQzHjdg.sign;
...
public class RSA {
    public static Logger LOG = LoggerFactory.getLogger(RSA.class);
    ...
    public static String md5s(String plainText) {
        ...
        try {
            ...
            LOG.error("base64:" + Base64.encode(buff.getBytes()));
            str = buf.toString();
            LOG.error("result: " + buf.toString());// 32位的加密
            LOG.error("result: " + buf.toString().substring(8, 24));// 16位的加密
