package com.account.plat.impl.weiuu;
...
@Component
public class WeiuuPlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/weiuu/", "plat.properties");
        // if (properties != null) {
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        ...
        try {
            ...
            if (code != 0) {
                LOG.error("weiuu 充值发货失败！！ " + code);
            }
            return "SUCCESS";
        } catch (Exception e) {
            LOG.error("weiuu 充值异常！！ ");
            e.printStackTrace();
            return "FAIL";
        }
    }
