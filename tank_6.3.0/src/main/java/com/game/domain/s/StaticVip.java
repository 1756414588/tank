/**   
 * @Title: StaticVip.java    
 * @Package com.game.domain.s    
 * @Description:   
 * @author ZhangJun   
 * @date 2015年9月24日 下午2:14:18    
 * @version V1.0   
 */
package com.game.domain.s;
...
public class StaticVip {
	...
	private int buyEnergyStone;// 能晶副本购买次数
	private int buyTreasure;// 购买荒宝副本（限时副本）次数
	private int waitQue;
	...
	private int buyShop;//VIP商店购买次数
	
	private int buyMedal;
	private float expup;
	private int buyTactic;
	...
	public int getBuyEnergyStone() {
		return buyEnergyStone;
	}

	public void setBuyEnergyStone(int buyEnergyStone) {
		this.buyEnergyStone = buyEnergyStone;
	}

	public int getBuyTreasure() {
		return buyTreasure;
	}

	public void setBuyTreasure(int buyTreasure) {
		this.buyTreasure = buyTreasure;
	}

	public int getBuyMedal() {
		return buyMedal;
	}

	public void setBuyMedal(int buyMedal) {
		this.buyMedal = buyMedal;
	}
    ...
    public void setBuyShop(int buyShop) {
        this.buyShop = buyShop;
    }

	public float getExpup() {
		return expup;
	}

	public void setExpup(float expup) {
		this.expup = expup;
	}

	public int getBuyTactic() {
		return buyTactic;
	}

	public void setBuyTactic(int buyTactic) {
		this.buyTactic = buyTactic;
	}
}
