package com.account.plat.impl.afNewMjdzh1Appstore;
...
@Component
public class AfNewMjdzh1AppstorePlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/afNewMjdzh1Appstore/", "plat.properties");
