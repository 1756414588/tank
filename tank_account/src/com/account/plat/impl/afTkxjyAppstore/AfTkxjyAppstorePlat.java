package com.account.plat.impl.afTkxjyAppstore;
...
@Component
public class AfTkxjyAppstorePlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/afTkxjyAppstore/", "plat.properties");
//		SIGN_KEY = properties.getProperty("SIGN_KEY");
    ...
    private void initRechargeMap() {
        RECHARGE_MAP.put(1, "com.anfan.tkxjy60");
        MONEY_MAP.put(1, 6);

        RECHARGE_MAP.put(2, "com.anfan.tkxjy300");
        MONEY_MAP.put(2, 30);

        RECHARGE_MAP.put(3, "com.anfan.tkxjy980");
        MONEY_MAP.put(3, 98);

        RECHARGE_MAP.put(4, "com.anfan.tkxjy1980");
        MONEY_MAP.put(4, 198);

        RECHARGE_MAP.put(5, "com.anfan.tkxjy3280");
        MONEY_MAP.put(5, 328);

        RECHARGE_MAP.put(6, "com.anfan.tkxjy6480");
        MONEY_MAP.put(6, 648);
    }
