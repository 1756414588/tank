...
/**
 * @author zhangdh
 * @ClassName: UnlockWeaponBarRsHandler
 * @Description:
 * @date 2017-11-15 11:15
 */
public class UnlockWeaponBarRsHandler implements ISimulaHandler {
    @Override
    public void doCommand(ChannelHandlerContext ctx, BasePb.Base msg) {
        GamePb6.UnlockWeaponBarRs res = msg.getExtension(GamePb6.UnlockWeaponBarRs.ext);
