package com.account.plat.impl.afGhgxsAppstore;
...
@Component
public class AfGhgxsAppstorePlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/afGhgxsAppstore/", "plat.properties");
    ...
    private void initRechargeMap() {
        RECHARGE_MAP.put(1, "com.hj.ghgxs60");
        MONEY_MAP.put(1, 6);

        RECHARGE_MAP.put(2, "com.hj.ghgxs300");
        MONEY_MAP.put(2, 30);

        RECHARGE_MAP.put(3, "com.hj.ghgxs980");
        MONEY_MAP.put(3, 98);

        RECHARGE_MAP.put(4, "com.hj.ghgxs1980");
        MONEY_MAP.put(4, 198);

        RECHARGE_MAP.put(5, "com.hj.ghgxs3280");
        MONEY_MAP.put(5, 328);

        RECHARGE_MAP.put(6, "com.hj.ghgxs6480");
        MONEY_MAP.put(6, 648);
    }
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        // TODO Auto-generated method stub
        LOG.error("pay afGhgxs_appstore");
        ...
        try {
            ...
            if (!APP_ID.equals(params.get("vid"))) {
                LOG.error("afGhgxs_appstore 充值应用ID不一致！！ ");
                return "ERROR";
            }
            ...
            if (sign.equalsIgnoreCase(originSign)) {
                ...
                if (code != 0) {
                    LOG.error("afGhgxs_appstore 充值发货失败！！ " + code);
                }
                return "SUCCESS";
            } else {
                LOG.error("afGhgxs_appstore 签名不一致！！ " + originSign + "|" + sign);
                return "ERROR";
            }
        } catch (Exception e) {
            LOG.error("afGhgxs_appstore 充值异常！！ " + e.getMessage());
            e.printStackTrace();
            return "ERROR";
        }
    }
