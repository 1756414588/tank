...
public class HttpUtils {
    ...
    public static String sendGet(String httpUrl, Map<String, String> parameter) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtil.info("sendGet exception");
        } finally {
            if (httpCon != null)
                httpCon.disconnect();
        }
    ...
    public static String sendPost(String httpUrl, String postBody, String encoding, Map<String, String> headerMap) {
        ...
        try {
            ...
            LogUtil.error("URL null", e1);
            return null;
        }
        try {
            httpCon = (HttpURLConnection) url.openConnection();
        } catch (IOException e1) {
            LogUtil.error("openConnection exception", e1);
            return null;
        }
        if (httpCon == null) {
        ...
        try {
            ...
            LogUtil.error("访问 ["+httpUrl+"] 错误", e1);
            return null;
        }
        try {
            if (postBody != null) {
