...
LOGIN_PLATFORM_PARAM = "mzYiwanCyzc_appstore"
...
function getPayCallBackUrl()
    return "http://mz_appstore.tank.hundredcent.com:9200/tank_account/account/payCallback.do?plat=mzYiwanCyzc_appstore"
end