package com.account.plat.impl.muzhiLy;
...
@Component
public class MuzhiLyPlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/muzhiLy/", "plat.properties");
    ...
    public GameError doLogin(DoLoginRq req, DoLoginRs.Builder response) {
        ...
        //String sid = userId + "_" + username + "_" + sign + "_"	+ timestamp;
        ...
        try {
            ...
            if (mysign.equals(sign)) {// 签名正确,做业务逻辑处理
                ...
                if (!AppID.equals(game_id)) {
                    LOG.error("muzhi 充值回调错误！！gameid: " + game_id);
                    return "success";
                }
                ...
                if (payStatus == 0) {
                    ...
                    if (code != 0) {
                        LOG.error("muzhi 充值发货失败！！ " + code);
                    }
                }
            }
        } catch (Exception e) {
            // TODO: handle exception
            LOG.error("muzhi 充值异常！！ ");
            e.printStackTrace();
        }
    ...
    private boolean verifyAccount(String userid, String usename, String sign, String timestamp) {
        LOG.error("muzhiLy 开始调用sidInfo接口");
...
/*	public static void main(String[] args) {
		...
		// String signGenerate = Rsa.getMD5(signSource).toLowerCase();
		String contentParam = "";
		contentParam = new String(Base64.decode(contentParam));
