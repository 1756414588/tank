--
-- Author: gf
-- Date: 2017-04-24 14:54:54
-- 安峰IOS 天启的狂怒HD

LOGIN_PLATFORM_PARAM = "afTqdknHD_appstore"
...
function getPayCallBackUrl()
    return "http://af_appstore.tank.hundredcent.com:9200/tank_account/account/payCallback.do?plat=afTqdknHD_appstore"
end