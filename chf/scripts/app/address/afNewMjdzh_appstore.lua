...
LOGIN_PLATFORM_PARAM = "afNewMjdzh_appstore"
...
function getPayCallBackUrl()
    return "http://af_appstore.tank.hundredcent.com:9200/tank_account/account/payCallback.do?plat=afNewMjdzh_appstore"
end