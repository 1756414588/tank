...
function CombatSectionTableView:ctor(size, viewFor)
	...
	--探险关卡
	self.explorePass = {EXPLORE_TYPE_EXTREME,EXPLORE_TYPE_PART,EXPLORE_TYPE_EQUIP,EXPLORE_TYPE_MEDAL,EXPLORE_TYPE_WAR,EXPLORE_TYPE_ENERGYSPAR} 
...
function CombatSectionTableView:createCellAtIndex(cell, index)
	...
	elseif self.m_viewFor == SECTION_VIEW_FOR_EXPLORE then
	else -- 探险
