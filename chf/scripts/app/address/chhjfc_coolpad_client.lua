...
--
--  草花红警复仇 -- 酷派
LOGIN_PLATFORM_PARAM = "chYhCoolpad"

GameConfig.accountURL = "http://chYhCoolpad.tank.hundredcent.com:9200/tank_account/account/account.do"
GameConfig.areaURL = "http://chYhCoolpad.tank.hundredcent.com/serverlist_tank.json"
...
function getPayCallBackUrl()
    return "http://chYhCoolpad.tank.hundredcent.com:9200/tank_account/account/payCallback.do?plat=chYhCoolpad"
end