package com.account.plat.impl.baidu;
...
@Component
public class BaiduPlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/baidu/", "plat.properties");
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        ...
        try {
            ...
            LOG.error("baidu 充值异常:" + e.getMessage());
            e.printStackTrace();
            return packResponse(1).toString();
        }
    }
