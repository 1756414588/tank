...
public enum GameError {
	...
	SERVER_MAINTENANCE(213, "SERVER_MAINTENANCE") {// 服务器维护中
	},
	...
	Fortress_DefencePalyer_IS_NOT_EXIST_OR_BE_OUT(692, "Fortress_DefencePalyer_IS_NOT_EXIST_OR_BE_OUT") {// 要塞防守玩家不存在或者被其他玩家击败
	},
	...
	Fortress_Add_Buff_Job_Just_App_Our_Party(700, "Fortress_Add_Buff_Job_Just_App_Our_Party") {// 增益类buff只能应用本军团成员
	},
	Fortress_Add_DeBuff_Job_Cant_APP_Our_Party(701, "Fortress_Add_DeBuff_Job_Cant_APP_Our_Party") {// 减益类buff只能应用非本军团成员
	},
	...
	TREASURE_NOT_EXISTS(720, "TREASURE_NOT_EXISTS") {// 宝物商店，商品不存在
	},
	TREASURE_WEEK_NOT_MATCH(721, "TREASURE_WEEK_NOT_MATCH") {// 宝物商店，不是这个星期售卖的商品
	},
	TREASURE_SHOP_NUM_LIMIT(722, "TREASURE_SHOP_NUM_LIMIT") {// 宝物商店，购买次数不足
	},
	Fortress_Ack_Can_Up_Hand(723, "Fortress_Ack_Can_Up_Hand") {// 进攻方才能购买奇兵
	},
	DRILL_WORLD_LV_LIMIT(724, "DRILL_WORLD_LV_LIMIT") {// 世界等级未达到
	},
	DRILL_STATUS_EROOR(725, "DRILL_STATUS_EROOR") {// 军事演习（红蓝大战） 状态不正确
	},
	DRILL_HAS_ENROLLED(726, "DRILL_HAS_ENROLLED") {// 军事演习（红蓝大战） 玩家已报过名
	},
	DRILL_NOT_ENROLLED(727, "DRILL_NOT_ENROLLED") {// 军事演习（红蓝大战） 玩家还未报名
	},
	DRILL_TANK_NOT_ENOUGH(728, "DRILL_TANK_NOT_ENOUGH") {// 军事演习（红蓝大战） 基地中坦克数量不足
	},
	DRILL_NOT_IN_RANK(729, "DRILL_NOT_IN_RANK") {// 军事演习（红蓝大战） 未上榜，不能领取排行榜奖励
	},
	DRILL_GET_REWARD(730, "DRILL_GET_REWARD") {// 军事演习（红蓝大战） 已领取过奖励
	},
	DRILL_SHOP_NOT_ENOUGH(731, "DRILL_SHOP_NOT_ENOUGH") {// 军事演习（红蓝大战）珍宝数量不足
	},
	DRILL_SHOP_BUY_LIMIT(732, "DRILL_SHOP_BUY_LIMIT") {// 军事演习（红蓝大战）商品已达购买上限
	},
	DRILL_EXPLOIT_NOT_ENOUGH(733, "DRILL_EXPLOIT_NOT_ENOUGH") {// 军事演习（红蓝大战）功勋值不足
	},
	DRILL_BUFF_MAX_LV(734, "DRILL_BUFF_MAX_LV") {// 军事演习（红蓝大战）已进修到最高等级
	},
	DRILL_BUFF_COST(735, "DRILL_BUFF_COST") {// 军事演习（红蓝大战）演习进修资源不足
	},
	REBEL_KILL_LIMIT(736, "REBEL_KILL_LIMIT") {// 叛军入侵，已达单次活动击杀上限
	},
	REBEL_NO_REWARD(737, "REBEL_NO_REWARD") {// 叛军入侵，排名没有奖励
	},
	REBEL_GET_REWARD(738, "REBEL_GET_REWARD") {// 叛军入侵，已领取排行奖励
	},
	ACT_POWER_FULL(739, "ACT_POWER_FULL") {// 能量补给活动，玩家能量充裕，无法在存储
	},
	ACT_POWER_ALREADY_GET(740, "ACT_POWER_ALREADY_GET") {// 能量补给活动，玩家已领取奖励
	},
	NOT_HAVE(741, "NOT_HAVE") {// 挂件或肖像未拥有
	},
	HAVED(742, "HAVED") {// 挂件或肖像已经拥有
	},
	PROP_REFRESH(743, "PROP_REFRESH") {// 物品以换新，请更新列表后查看哦
	},
	MEDAL_CHIP_NOT_ENOUGH(744, "MEDAL CHIP NOT ENOUGH") {// 勋章碎片不足
	},
	NO_MEDAL(745, "DON'T HAVA THIS MEDAL") {// 没有此勋章
	},
	FULL_MEDAL_ON(746, "FULL_MEDAL_ON") {// 勋章已穿戴满
	},
	ALRADY_ON_MEDAL(747, "ALRADY_ON_MEDAL") {// 此类型寻装已穿戴
	},
	MAX_MEDAL_STORE(748, "MAX_MEDAL_STORE") {// 勋章仓库已达上限
	},
	MAX_MEDAL_UP_LV(749, "MAX_MEDAL_UP_LV") {// 勋章强化已达上限
	},
	MEDAL_LOCKED(750, "MEDAL_LOCKED") {// 勋章已锁定
	},
	MEDAL_UP_CD_ENOUGH(751, "MEDAL_UP_CD_ENOUGH") {// 勋章强化cd不足
	},
	MAX_MEDAL_REFIT_LV(752, "MAX_MEDAL_REFIT_LV") {// 勋章改造已达上限
	},
	SCOUT_CD_TIME_ENOUGH(753, "SCOUT_CD_TIME_ENOUGH") {// 侦查cd不足
	},
	NO_MEDAL_BOUNS(754, "NO_MEDAL_BOUNS") {// 没有获得过此勋章
	},
	ALRADY_ON_MEDAL_BOUNS(755, "ALRADY_ON_MEDAL_BOUNS") {// 此勋章已展示过
	},
	ACT_BOSS_NO_IN_TIME(756, "ACT_BOSS_NO_IN_TIME") {// 不在召唤时间内
	},
	ACT_BOSS_ALRADY_CALLED(757, "ACT_BOSS_ALRADY_CALLED") {// 已经被召唤
	},
	ACT_BOSS_CD_ENOUGH(758, "ACT_BOSS_ALRADY_CALLED") {// CD不够
	},
	ACT_BOSS_NO_CALL(759, "ACT_BOSS_NO_CALL") {// 未召唤
	},
	DAY_7_ACT_ARENA_RANK_ENOUGH(760, "DAY_7_ACT_ARENA_RANK_ENOUGH") {// 7日活动排名未达到
	},
	AIRSHIP_AT_SAFE_TIME(761, "AIRSHIP_AT_SAFE_TIME") {// 飞艇处于免战时间
	},
	AIRSHIP_HAVED(762, "AIRSHIP_HAVED") {// 飞艇已经被我方军团占领
	},
	TEAM_CREATED(763, "TEAM_CREATED") {// 集结已经创建
	},
	TEAM_CANCELD(764, "TEAM_CANCELD") {// 集结已经取消
	},
	TEAM_NO_CREATE(765, "TEAM_NO_CREATE") {// 集结未创建
	},
	TEAM_MARCH(766, "TEAM_MARCH") {// 集结行军中
	},
	ARMY_RETREAT(767, "ARMY_RETREAT") {// 部队已撤销
	},
	QUIT_PARTY_AIRSHIP_ARMY_MARCH(768, "QUIT_PARTY_AIRSHIP_ARMY_MARCH") {// 有针对飞艇攻击的(行军)队伍不能离开军团
	},
	AIRSHIP_PRODUCE_ENOUGH(769, "AIRSHIP_PRODUCE_ENOUGH") {// 飞艇生产道具不足
	},
	NOT_AIRSHIP_LEADER(770, "NO_AIRSHIP_LEADER") {// 不是飞艇指挥官
	},
	QUIT_PARTY_AIRSHIP_COMMANDER_ERR(771, "QUIT_PARTY_AIRSHIP_COMMANDER_ERR") {// 飞艇指挥官不能退出军团
	},
	ALREADY_HAS_AIRSHIP_ERR(772, "ALREADY_HAS_AIRSHIP_ERR") {// 已经拥有飞艇指挥权
	},
	AIRSHIP_NOT_FOUND_ERR(773, "ALREADY_NOT_FOUND_ERR") {// 飞艇不存在
	},
	AIRSHIP_NOT_BELONG_MY_PARTY(774, "AIRSHIP_NOT_BELONG_MY_PARTY") {// 飞艇不属于本公会
	},
	AIRSHIP_DURABILITY_FULL(775, "AIRSHIP_DURABILITY_FULL") {// 飞艇耐久度已满
	},
	AIRSHIP_TEAM_CHANGE_ERR(776, "AIRSHIP_TEAM_CHANGE_ERR") {// 飞艇队伍已变更
	},
	AIRSHIP_DURABILITY_NOT_FULL(777, "AIRSHIP_DURABILITY_NOT_FULL") {// 飞艇耐久度未满
	},
	AIRSHIP_UN_LOCK(778, "AIRSHIP_UN_LOCK") {// 飞艇未解锁
	},
	AIRSHIP_TEAM_ARMY_NOT_FOUND(779, "AIRSHIP_TEAM_ARMY_NOT_FOUND") {// 飞艇进攻队伍没找到
	},
	AIRSHIP_GUARD_ARMY_NOT_FOUND(780, "AIRSHIP_GUARD_ARMY_NOT_FOUND") {// 飞艇驻防部队没找到
	},
	QUIT_PARTY_AIRSHIP_TEAM_LEADER_ERR(781, "QUIT_PARTY_AIRSHIP_TEAM_LEADER_ERR") {// 飞艇进攻集结队伍的队长不能退出军团
	},
	CANNOT_MEDAL_TRANS(782, "CANNOT_MEDAL_TRANS") {// 此勋章无法精炼
	},
	TRANS_NOT_ENOUGH(783, "TRANS_NOT_ENOUGH") {// 精炼材料不够
	},
	HAS_SOLD(784, "TRANS_NOT_ENOUGH") {// 物品已售罄
	},
	CANNT_CROSSREG_CASE_FIGHTORRANKREASON(801, "CANNT_CROSSREG_CASE_FIGHTORRANKREASON") { // 战力或者排名没有达到报名条件
	},
	...
	CROSS_CANT_RECEVIE_BET_CAUSE_NO_FIGHT(815, "CROSS_CANT_RECEVIE_BET_CAUSE_NO_FIGHT") {// 没有战斗不能领取奖励
	},
	...
	ALTAR_BOSS_READY(830, "ALTAR_BOSS_READY") { // 祭坛BOSS准备战斗中不可捐献
	},
	ALTAR_BOSS_UPLIMIT(831, "ALTAR_BOSS_UPLIMIT") { // 祭坛BOSS经验超出上限
	},
	...
	CROSS_PARTY_CANT_SET_FORM_CASE_NO_REG(857, "CROSS_PARTY_CANT_SET_FORM_CASE_NO_REG") {// 没有报名不能设置阵型
	},
	...
	SAME_IP(1445, "SAME_IP") {// 领取叛军红包 ,相同ip一个红包只能领取一次

	},

	LEVEL_NOT_ENOUGH(1446, "LEVEL_NOT_ENOUGH") {// 等级不足

	},

	CROSS_SERVER_ERR(2000,"CROSS_SERVER_ERR"){//跨服链接错误
	},

	CROSS_CHAT_ERR(2001,"CROSS_CHAT_ERR"){
		//跨服聊天错误
	};
