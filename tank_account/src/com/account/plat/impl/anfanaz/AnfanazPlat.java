package com.account.plat.impl.anfanaz;
...
@Component
public class AnfanazPlat extends PlatBase {
    // sdk server的接口地址
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/anfanaz/", "plat.properties");
    ...
    public GameError doLogin(DoLoginRq req, DoLoginRs.Builder response) {
        ...
        AnfanazAccount anfanAccount = verifyAccount(uid, ucid, uuid);
    ...
    private AnfanazAccount verifyAccount(String uid, String ucid, String uuid) {
        try {
            LOG.error("anfanaz开始调用sidInfo接口:" + serverUrl);
            ...
            AnfanazAccount account = new AnfanazAccount();
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        ...
        try {
            ...
            if (sign.equalsIgnoreCase(originSign)) {
                ...
                if (code != 0) {
                    LOG.error("anfanaz 充值发货失败！！ " + code);
                }
                return "SUCCESS";
            } else {
                LOG.error("anfanaz 签名不一致！！ " + originSign + "|" + sign);
                return "ERROR";
            }
        } catch (Exception e) {
            LOG.error("anfanaz 充值异常！！ ");
            e.printStackTrace();
            return "ERROR";
        }
    }
