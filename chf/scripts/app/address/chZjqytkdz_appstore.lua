...
LOGIN_PLATFORM_PARAM = "chZjqytkdz_appstore"
...
function getPayCallBackUrl()
    return "http://ch_appstore.tank.hundredcent.com:9200/tank_account/account/payCallback.do?plat=chZjqytkdz_appstore"
end