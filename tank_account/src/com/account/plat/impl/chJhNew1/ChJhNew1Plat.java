package com.account.plat.impl.chJhNew1;
 ...
 */
@Component
public class ChJhNew1Plat extends PlatBase {
    ...
    @PostConstruct
    public void init() {
        Properties properties = loadProperties("com/account/plat/impl/chJhNew1/", "plat.properties");
     ...
     * @return
     */
    public static int getNewPlatNo() {
        return 82;
    }
    ...
    public String payBack(WebRequest request, String content, HttpServletResponse response) {
        LOG.error("pay chJhNew1 payBack");
        LOG.error("chJhNew1 接收到的参数" + content);
        ...
        try {
            ...
            while (iterator.hasNext()) {
                ...
                LOG.error("chJhNew1 " + paramName + ":" + request.getParameter(paramName));
                params.put(paramName, URLDecoder.decode(request.getParameter(paramName), "UTF-8"));
            }
            LOG.error("chJhNew1 参数结束");
            ...
            LOG.error("chJhNew1 md5str =" + sb.toString() + " md5val=" + toMD5);
            if (!params.get("sign").equals(toMD5)) {
                result.put("code", 203);
            ...
            String extra = params.get("orderno_cp");
            ...
            if (code != 0) {
                LOG.error("chJhNew1 充值发货失败！！ " + code);
                result.put("code", 205);
                result.put("msg", "系统错误");
                return result.toString();
            }
