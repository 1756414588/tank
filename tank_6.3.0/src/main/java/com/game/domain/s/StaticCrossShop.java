...
/**
 * @ClassName StaticCrossShop.java
 * @Description 跨服战商店配置
 * @author TanDonghai
...
public class StaticCrossShop {
	...
	public String toString() {
		return "StaticCrossShop [goodID=" + goodID + ", goodName=" + goodName + ", type=" + type + ", treasure="
				+ treasure + ", cost=" + cost + ", personNumber=" + personNumber + ", totalNumber=" + totalNumber
