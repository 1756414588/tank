...
/**
* @ClassName: MapDoubleTypeHandler 
* @Description: CHAR型字段[[id,count],[id,count],[id,count]]适配Map<Integer, Double>
* @author
 */
public class MapDoubleTypeHandler extends BaseTypeHandler<Map<Integer, Double>> {
	...
	@Override
	public void setNonNullParameter(PreparedStatement arg0, int arg1, Map<Integer, Double> arg2, JdbcType arg3) throws SQLException {
		//Auto-generated method stub
